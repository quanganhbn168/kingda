...
Route::middleware('set-locale')->group(function (): void {
    ...
    Route::post('/san-pham/{product}/tu-van', [ProductController::class, 'storeConsultation'])->middleware('throttle:5,1')->name('products.consultation.store');
    ...
    Route::prefix('{locale}')
        ...
        ->group(function (): void {
            ...
            Route::post('/newsletter', [PageController::class, 'subscribeNewsletter'])->middleware('throttle:5,1')->name('localized.newsletter.subscribe');
